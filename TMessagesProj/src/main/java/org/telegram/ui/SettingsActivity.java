...
import com.chatgram.features.settings.ChatGramSettingsActivity;
...
//        fragmentView.addView(navigationBar, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, 0, Gravity.BOTTOM | Gravity.FILL_HORIZONTAL));
    ...
    private void fillItems(ArrayList<UItem> items, UniversalAdapter adapter) {
        ...
        items.add(SettingCell.Factory.of(99, IconBackgroundColors.RED.top, IconBackgroundColors.RED.bottom, R.drawable.settings_folders, "ChatGram Settings", "Ghost Mode, Decoy Vault, and filters"));
    ...
    private void onClick(UItem item, View view, int position, float x, float y) {
        ...
        switch (item.id) {
            ...
            case 3:
                ...
                break;
            case 99:
                presentFragment(new ChatGramSettingsActivity());
                break;
            case 5:
